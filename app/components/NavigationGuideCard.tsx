...
const cardClasses =
  'bg-gray-900/40 backdrop-blur-xl rounded-2xl border border-white/10 p-8 transition-all duration-200 hover:scale-[1.02] hover:border-white/20 h-full';

export default function NavigationGuideCard() {
  return (
    <div className="space-y-4 md:space-y-6">
      {/* Card 1: Mana Rīku Kaste (My Stack) */}
      <div className={cardClasses}>
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
          🛠️ Mana Rīku Kaste (My Stack)
        </h2>
      ...
      {/* Card 2: Digitalizācijas Vīzija: Latvija 2.0 */}
      <div className={cardClasses}>
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
          🏛️ Digitalizācijas Vīzija: Latvija 2.0
        </h2>
        <div className="space-y-4">
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed">
